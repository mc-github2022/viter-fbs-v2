...
const WebDesignPricing = ({ pageName }) => {
            ...
            <div className="wrapper md:grid md:grid-cols-2 gap-8 items-center">
              {pricing.map((price, key) => {
                return (
                  <div
                    key={key}
                    className={`priceItem mb-5 md:mb-0 relative z-[1] text-light text-center p-10 rounded-lg addShadow md:min-h-[650px] lg:min-h-[600px] ${
                      price.isActive
                        ? "bg-primary "
