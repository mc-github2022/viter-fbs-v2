...
const GraphicDesignPricing = ({ pageName }) => {
  ...
  return (
    <>
      <section className="GraphicDesignPricing py-20 bg-[#000000] relative overflow-hidden">
      ...
      {contactForm && (
        <ModalContact
          ...
          emailSubject={`CONTACT US / Graphic Design (${contactSubject}) - `}
        />
      )}
    </>
  );
