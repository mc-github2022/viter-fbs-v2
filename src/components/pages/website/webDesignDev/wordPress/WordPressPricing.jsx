...
const WordPressPricing = ({ pageName }) => {
  ...
  return (
    <>
      <section className="WordPressPricing py-20 bg-[#000000] relative overflow-hidden">
            ...
            <div className="wrapper md:grid md:grid-cols-2 gap-6 items-center">
              {pricing.map((price, key) => {
                return (
                  <div
                    key={key}
                    className={`priceItem mb-5 md:mb-0 relative z-[1] md:min-h-[700px] lg:min-h-[600px] text-light text-center p-10 rounded-lg addShadow ${
