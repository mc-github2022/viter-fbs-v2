...
const ServiceBookingPricing = ({ pageName, bookingTitlesData }) => {
  ...
  const selectedCategory =
    packagesListData?.data?.find(
      (item) => item.packages_category_url === "webapp-online-booking",
    )?.packages_category_url || "webapp-online-booking";
  ...
  return (
    <>
      <section className="ServiceBookingPricing py-20 bg-[#000000] relative overflow-hidden">
...
export default ServiceBookingPricing;
