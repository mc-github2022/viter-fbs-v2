                  ...
                  if (
                    ...
                    return (
                      <div key={key} className="md:h-fit">
                        <div className="testimonialItem bg-customGray lg:grid lg:grid-cols-[_2fr_1fr] items-center md:top-[50%] py-10 px-10 md:px-20 md:pt-16 pb-9 mb-5 rounded-xl md:w-ful mx-auto relative">
