        ...
        <div className="customContainer">
          <div className="mb-10 text-center relative z-[3]">
            <p className="text-light">
              {socialTitlesData?.data?.[0]?.social_titles_packages_subtitle ||
                ""}
            </p>
            <h3 className="text-[clamp(20px,7vw,35px)] font-semibold leading-[1.1] text-light">
              {socialTitlesData?.data?.[0]?.social_titles_packages_title || ""}
            </h3>
          </div>
...
export default VaSocialMediaManagementPricing;
