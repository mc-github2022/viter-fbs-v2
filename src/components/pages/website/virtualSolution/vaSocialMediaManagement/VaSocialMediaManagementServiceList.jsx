...
const VaSocialMediaManagementServiceList = ({ pageName }) => {
  ...
  return (
    <>
      <section
        className=" pt-0 pb-20 lg:pt-10"
        id="VaSocialMediaManagementServiceList"
      >
      ...
      {contactForm && (
        <ModalContact
          ...
          emailSubject={`GET STARTED / Social Media Management - `}
        />
      )}
    </>
  );
...
export default VaSocialMediaManagementServiceList;
