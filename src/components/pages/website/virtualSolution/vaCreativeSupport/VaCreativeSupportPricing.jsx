...
const VaCreativeSupportPricing = () => {
  return (
    <>
      <section className="VaCreativeSupportPricing py-20 bg-[#000000] relative overflow-hidden">
...
export default VaCreativeSupportPricing;
