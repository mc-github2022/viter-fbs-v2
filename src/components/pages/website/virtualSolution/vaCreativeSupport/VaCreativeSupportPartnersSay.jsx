...
const VaCreativeSupportPartnersSay = () => {
  ...
  return (
    <>
      <section className="VaCreativeSupportPartnersSay py-20">
          ...
          <div className="wrapper ">
            <Slider {...partnerSaysSettings}>
              {clientSays.map((testimonial, key) => {
                return (
                  <div key={key} className="h-[425px] grid place-items-center">
...
export default VaCreativeSupportPartnersSay;
