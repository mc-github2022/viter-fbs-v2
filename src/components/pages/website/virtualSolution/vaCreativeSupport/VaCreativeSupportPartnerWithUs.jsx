...
const VaCreativeSupportPartnerWithUs = () => {
  return (
    <>
      <section className="VaCreativeSupportPartnerWithUs py-20 relative overflow-hidden mb-20 ">
...
export default VaCreativeSupportPartnerWithUs;
