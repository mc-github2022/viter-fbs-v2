...
const VaTechSupportPartnerWithUs = () => {
  return (
    <>
      <section className="VaTechSupportPartnerWithUs py-20 relative overflow-hidden mb-20 ">
...
export default VaTechSupportPartnerWithUs;
