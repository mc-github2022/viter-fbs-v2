...
const VaTechSupportServiceList = () => {
  return (
    <>
      <section className="VaTechSupportServiceList pt-20 pb-40">
        <div className="customContainer">
          <div className="sectionDesc text-center md:w-[70%] mx-auto mb-14">
            <h2 className="text-[clamp(20px,6vw,60px)] leading-[1.1] font-semibold mb-10">
              What <span className="text-primary">Technical Support </span>{" "}
              <br />
              Can We Perform?
            </h2>
          ...
          <ul className="serviceInclusion w-[450px] mx-auto">
            <li className="flex items-center gap-7 mb-7 ">
              <div className="bg-customGray rounded-lg addShadow">
                <div className="w-16 h-16 grid place-items-center">
                  <Globe size={28} className="text-3xl text-primary" />
                </div>
              </div>
            ...
            <li className="flex items-center gap-7 mb-7 ">
              <div className="bg-customGray rounded-lg addShadow">
                <div className="w-16 h-16 grid place-items-center">
                  <Wrench size={28} className="text-3xl text-primary" />
                </div>
              </div>
              <p className="font-semibold text-xl lg:text-2xl">
            ...
            <li className="flex items-center gap-7 mb-7 ">
              <div className="bg-customGray rounded-lg addShadow">
                <div className="w-16 h-16 grid place-items-center">
                  <Settings size={28} className="text-3xl text-primary" />
                </div>
              </div>
              <p className="font-semibold text-xl lg:text-2xl">
                Software Setup
...
export default VaTechSupportServiceList;
