export const eventsAndAct = [
  {
    postTitle: "Events 5 Reason Your Business Needs a Custom Web Application",
    postSlug: "5-reason-your-business-needs-a-custom-web-application",
    postCategory: "Web Development",
    postDate: "July 4, 2024",
    postImage: "webdevv.jpg",
    postContent: (
  ...
  {
    postTitle: "Events How Virtual Assistants Can Boost You Productivity",
    postSlug: "how-virtual-assistants-can-boost-you-productivity",
    postCategory: "Virtual Office",
    postDate: "July 4, 2024",
    postImage: "vablog.jpg",
    postContent: (
      <div className="postContent">
        <p className="mb-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Et sit
  ...
  },
  {
    ...
    postSlug: "skills-requirement-for-fresh-graduates",
    postCategory: "Skill Development",
    postDate: "July 4, 2024",
    postImage: "skilldev.jpg",
    postContent: (
      <div className="postContent">
        <p className="mb-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Et sit
