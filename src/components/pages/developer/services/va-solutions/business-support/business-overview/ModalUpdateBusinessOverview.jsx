...
const ModalUpdateBusinessOverview = ({ itemEdit, businessOverviewData }) => {
  ...
  const initVal = {
    ...
    business_overview_img:
      businessOverviewData?.data?.[0]?.business_overview_img ?? "",

    business_overview_img_old:
      businessOverviewData?.data?.[0]?.business_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                business_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="business_overview_subtitle"
...
export default ModalUpdateBusinessOverview;
