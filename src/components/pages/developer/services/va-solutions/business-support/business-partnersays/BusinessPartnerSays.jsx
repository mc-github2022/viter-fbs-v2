        ...
        <div className="customContainer max-w-[90%]">
            ...
            <div className="relative">
              <p>
                {businessTitlesData?.data?.[0]
                  ?.business_titles_testimonial_subtitle || "Subtitle"}
              </p>
              <h2 className="text-[clamp(20px,7vw,35px)] font-semibold text-primary leading-[1.1] mb-8">
                {businessTitlesData?.data?.[0]
                  ?.business_titles_testimonial_title || "Title"}
              </h2>
              <a
                className="absolute cursor-pointer tooltip-btn -top-4 left-[20rem] "
                data-tooltip="Edit contents"
                onClick={handleUpdateBusinessTestimonialTitles}
              >
          ...
          <div className="wrapper ">
            {IndtestimonialData?.data.filter(
              (item) =>
                item.industry_testimonial_category === "Business Support"
            ).length > 1 ? (
...
export default BusinessPartnerSays;
