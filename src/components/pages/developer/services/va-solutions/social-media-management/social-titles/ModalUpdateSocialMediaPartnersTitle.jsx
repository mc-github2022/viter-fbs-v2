...
const ModalUpdateSocialMediaPartnersTitle = ({
  itemEdit,
  socialTitlesData,
}) => {
  ...
  const initVal = {
    ...
    social_titles_partners_subtitle:
      socialTitlesData?.data?.[0]?.social_titles_partners_subtitle ?? "",
    social_titles_partners_title:
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Social Media Management Partners Title
          </h2>
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="social_titles_partners_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="social_titles_partners_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateSocialMediaPartnersTitle;
