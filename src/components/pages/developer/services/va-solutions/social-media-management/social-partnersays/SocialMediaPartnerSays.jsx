        ...
        <div className="customContainer max-w-[90%]">
          {IndtestimonialData?.data.length > 0 && (
            <div className="relative">
              <p>
                {socialTitlesData?.data?.[0]
                  ?.social_titles_testimonial_subtitle || "Subtitle"}
              </p>
              ...
              <a
                ...
                onClick={handleUpdateSocialTestimonialTitles}
              >
          ...
          <div className="wrapper ">
            {IndtestimonialData?.data.filter(
              (item) =>
                item.industry_testimonial_category === "Social Media Management"
            ).length > 1 ? (
...
export default SocialMediaPartnerSays;
