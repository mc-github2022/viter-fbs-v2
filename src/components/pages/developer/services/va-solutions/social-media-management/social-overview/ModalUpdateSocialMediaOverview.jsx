...
const ModalUpdateSocialMediaOverview = ({ itemEdit, socialOverviewData }) => {
  ...
  const initVal = {
    ...
    social_overview_subtitle:
      socialOverviewData?.data?.[0]?.social_overview_subtitle ?? "",
    social_overview_title:
      socialOverviewData?.data?.[0]?.social_overview_title ?? "",
    social_overview_img:
      socialOverviewData?.data?.[0]?.social_overview_img ?? "",

    social_overview_img_old:
      socialOverviewData?.data?.[0]?.social_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                social_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
...
export default ModalUpdateSocialMediaOverview;
