...
const ModalUpdateMarketingOverview = ({ itemEdit, marketingOverviewData }) => {
  ...
  const initVal = {
    ...
    marketing_overview_img:
      marketingOverviewData?.data?.[0]?.marketing_overview_img ?? "",

    marketing_overview_img_old:
      marketingOverviewData?.data?.[0]?.marketing_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                marketing_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="marketing_overview_subtitle"
...
export default ModalUpdateMarketingOverview;
