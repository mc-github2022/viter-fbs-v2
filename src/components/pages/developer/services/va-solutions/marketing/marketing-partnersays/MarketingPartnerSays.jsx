            ...
            <div className="relative">
              <p>
                {marketingTitlesData?.data?.[0]
                  ?.marketing_titles_testimonial_subtitle || "Subtitle"}
              </p>
              <h2 className="text-[clamp(20px,7vw,35px)] font-semibold text-primary leading-[1.1] mb-8">
                {marketingTitlesData?.data?.[0]
                  ?.marketing_titles_testimonial_title || "Title"}
              </h2>
              <a
                className="absolute cursor-pointer tooltip-btn -top-4 left-[20rem] "
                data-tooltip="Edit contents"
                onClick={handleUpdateMarketingTestimonialTitles}
              >
...
export default MarketingPartnerSays;
