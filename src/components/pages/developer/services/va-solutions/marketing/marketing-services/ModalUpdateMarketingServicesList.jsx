...
const ModalUpdateMarketingServicesList = ({ itemEdit }) => {
  const { store, dispatch } = React.useContext(StoreContext);
  const [animate, setAnimate] = React.useState("translate-x-full");

  const [searchTerm, setSearchTerm] = React.useState(
    itemEdit ? itemEdit.marketing_services_list_icon : ""
  );
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/marketing-services-list/${itemEdit.marketing_services_list_aid}` // update
          : `${apiVersion}/marketing-services-list`, // create
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
  ...
  const initVal = {
    marketing_services_list_title: itemEdit
      ? itemEdit.marketing_services_list_title
      : "",
    marketing_services_list_icon: itemEdit
      ? itemEdit.marketing_services_list_icon
      : "",
  };
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Marketing Services List
          </h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              const data = {
                ...values,
                marketing_services_list_icon: selectedIcon,
              };
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper" ref={refSearch}>
                      <InputText
                        label="Search Icon"
                        type="text"
                        name="marketing_services_list_icon"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="marketing_services_list_title"
...
export default ModalUpdateMarketingServicesList;
