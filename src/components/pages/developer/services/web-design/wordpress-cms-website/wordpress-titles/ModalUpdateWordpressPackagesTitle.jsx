...
const ModalUpdateWordpressPackagesTitle = ({
  itemEdit,
  wordpressTitlesData,
}) => {
  ...
  const initVal = {
    ...
    wordpress_titles_packages_subtitle:
      wordpressTitlesData?.data?.[0]?.wordpress_titles_packages_subtitle ?? "",
    wordpress_titles_packages_title:
      wordpressTitlesData?.data?.[0]?.wordpress_titles_packages_title ?? "",
  };
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Wordpress Packages Title
          </h2>
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="wordpress_titles_packages_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="wordpress_titles_packages_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPackagesTitle;
