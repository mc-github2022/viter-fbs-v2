...
const ModalUpdateWordpressOverview = ({ itemEdit, wordpressOverviewData }) => {
  ...
  const initVal = {
    ...
    wordpress_overview_button_text:
      wordpressOverviewData?.data?.[0]?.wordpress_overview_button_text ?? "",
    wordpress_overview_img:
      wordpressOverviewData?.data?.[0]?.wordpress_overview_img ?? "",

    wordpress_overview_img_old:
      wordpressOverviewData?.data?.[0]?.wordpress_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="wordpress_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="wordpress_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressOverview;
