...
const ModalUpdateWordpressPortfolioC = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_c:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_c ?? "",
    wordpress_portfolio_url_c:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_c ?? "",
    wordpress_portfolio_img_c:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_c ?? "",

    wordpress_portfolio_img_c_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_c ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_c: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_c"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_c"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioC;
