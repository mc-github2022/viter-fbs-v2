...
const ModalUpdateWordpressPortfolioB = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_b:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_b ?? "",
    wordpress_portfolio_url_b:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_b ?? "",
    wordpress_portfolio_img_b:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_b ?? "",

    wordpress_portfolio_img_b_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_b ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_b: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_b"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_b"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioB;
