...
const ModalUpdateWordpressPortfolioD = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_d:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_d ?? "",
    wordpress_portfolio_url_d:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_d ?? "",
    wordpress_portfolio_img_d:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_d ?? "",

    wordpress_portfolio_img_d_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_d ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_d: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_d"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_d"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioD;
