...
const ModalUpdateWordpressPortfolioH = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_h:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_h ?? "",
    wordpress_portfolio_url_h:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_h ?? "",
    wordpress_portfolio_img_h:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_h ?? "",

    wordpress_portfolio_img_h_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_h ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_h: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_h"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_h"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioH;
