...
const ModalUpdateWordpressPortfolioF = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_f:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_f ?? "",
    wordpress_portfolio_url_f:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_f ?? "",
    wordpress_portfolio_img_f:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_f ?? "",

    wordpress_portfolio_img_f_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_f ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_f: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_f"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_f"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioF;
