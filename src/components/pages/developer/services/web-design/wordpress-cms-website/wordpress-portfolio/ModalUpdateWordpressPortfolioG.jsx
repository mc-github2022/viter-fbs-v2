...
const ModalUpdateWordpressPortfolioG = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_g:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_g ?? "",
    wordpress_portfolio_url_g:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_g ?? "",
    wordpress_portfolio_img_g:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_g ?? "",

    wordpress_portfolio_img_g_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_g ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_g: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_g"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_g"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioG;
