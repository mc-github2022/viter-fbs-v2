...
const ModalUpdateWordpressPortfolioE = ({
  itemEdit,
  ...
  const initVal = {
    ...
    wordpress_portfolio_website_e:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_website_e ?? "",
    wordpress_portfolio_url_e:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_url_e ?? "",
    wordpress_portfolio_img_e:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_e ?? "",

    wordpress_portfolio_img_e_old:
      wordpressPortfolioData?.data?.[0]?.wordpress_portfolio_img_e ?? "",
    pendingDeleteFile: [],
  };
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} WordPress Portfolio
          </h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                wordpress_portfolio_img_e: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Website"
                        type="text"
                        name="wordpress_portfolio_website_e"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="URL"
                        type="text"
                        name="wordpress_portfolio_url_e"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWordpressPortfolioE;
