            ...
            <div className=" pb-4 ">
              <div className="list-content mx-0">
                <div className="list-button border-l-4 border-transparent hover:border-l-4 pl-1 hover:border-primary hover:transition-all hover:ease-in-out">
                  <Link
                    to={`${devNavUrl}/services/web-design-and-development/wordpress`}
                ...
                <div className="list-button border-l-4 border-transparent hover:border-l-4 pl-1 hover:border-primary hover:transition-all hover:ease-in-out ">
                  <Link
                    to={`${devNavUrl}/services/web-design-and-development/single-page-website`}
                    className="flex items-center gap-2 py-3 "
                  >
                    <span className="flex items-center gap-2  text-xs font-bold">
                      Single Page Website
                ...
                <div className="list-button border-l-4 border-transparent hover:border-l-4 pl-1 hover:border-primary hover:transition-all hover:ease-in-out ">
                  <Link
                    to={`${devNavUrl}/services/web-design-and-development/web-design`}
                    className="flex items-center gap-2 py-3 "
                  >
                    <span className="flex items-center gap-2  text-xs font-bold">
                      Web Design
                ...
                <div className="list-button border-l-4 border-transparent hover:border-l-4 pl-1 hover:border-primary hover:transition-all hover:ease-in-out ">
                  <Link
                    to={`${devNavUrl}/services/web-design-and-development/graphic-design`}
                    className="flex items-center gap-2 py-3 "
                  >
                    <span className="flex items-center gap-2  text-xs font-bold">
                      Graphic Design
...
export default WebDesignAndDevAdmin;
