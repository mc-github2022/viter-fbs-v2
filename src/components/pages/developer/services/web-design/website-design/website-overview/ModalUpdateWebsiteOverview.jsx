...
const ModalUpdateWebsiteOverview = ({ itemEdit, websiteOverviewData }) => {
  ...
  const initVal = {
    ...
    website_overview_subtitle:
      websiteOverviewData?.data?.[0]?.website_overview_subtitle ?? "",
    website_overview_title:
      websiteOverviewData?.data?.[0]?.website_overview_title ?? "",
    website_overview_button_text:
      websiteOverviewData?.data?.[0]?.website_overview_button_text ?? "",
    website_overview_img:
      websiteOverviewData?.data?.[0]?.website_overview_img ?? "",
    website_overview_file:
      websiteOverviewData?.data?.[0]?.website_overview_file ?? "",

    website_overview_img_old:
      websiteOverviewData?.data?.[0]?.website_overview_img ?? "",
    website_overview_file_old:
      websiteOverviewData?.data?.[0]?.website_overview_file ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                website_overview_img: logoImages.map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                ),
                website_overview_file: clientImages.map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="website_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="website_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWebsiteOverview;
