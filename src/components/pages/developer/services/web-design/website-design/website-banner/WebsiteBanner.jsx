...
const WebsiteBanner = ({
  ...
  return (
    <>
      ...
      >
        {websiteData?.data?.length > 0 && websiteBannerImage?.length > 0 ? (
          <>
            ...
            <div className="text-center py-10 lg:text-left">
              <h2 className="text-[clamp(30px,3vw,45px)] leading-[1.1] mb-8 text-light font-light">
                ...
                <span className="text-light font-semibold">
                  {websiteData?.data?.[0]?.website_banner_title_bold || "Title"}
                </span>
              </h2>
