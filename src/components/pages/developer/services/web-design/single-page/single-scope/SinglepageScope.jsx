...
const SinglepageScope = ({
  handleUpdateSinglepageScopeTitles,
  handleUpdateSinglepageScope,
  isLoadingScope,
  isFetchingScope,
  errorScope,
  setItemEdit,
  ...
  const handleDelete = (scopeList) => {
    ...
    setIsData(scopeList.singlepage_scope_title);
    setIsId(scopeList.singlepage_scope_aid);
  };
    ...
    <>
        ...
        <div className="customContainer relative">
          <div className="relative">
            <a
              ...
              onClick={handleUpdateSinglepageScopeTitles}
            >
              <HiPencil className=" bg-[#C7AC27] rounded-full  w-[25px] h-[25px] p-[5px] border-[1px] text-black" />
            </a>
            <p>
              {singlepageTitlesData?.data?.[0]
                ?.singlepage_titles_overview_subtitle || "Subtitle"}
            </p>
            <h2 className="text-[clamp(20px,7vw,35px)] font-semibold text-primary leading-[1.1] mb-8">
              {singlepageTitlesData?.data?.[0]
                ?.singlepage_titles_overview_title || "Title"}
            </h2>
          </div>
          <a
            className="absolute cursor-pointer right-[6rem] top-2"
            onClick={handleUpdateSinglepageScope}
          >
          ...
          {(isLoadingScope || singlepageScopeData?.data?.length === 0) && (
      ...
      {store.isDelete && (
        <ModalDelete
          ...
          queryKey={"singlepage-scope"}
          mysqlEndpoint={`/v1/singlepage-scope/${id}`}
          item={isData}
        />
      )}
