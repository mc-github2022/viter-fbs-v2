...
const SinglepagePricing = ({
  ...
  const selectedCategory =
    packagesListData?.data?.find(
      (item) => item.packages_category_url === "web-singlepage"
    )?.packages_category_url || "web-singlepage";
        ...
        <div className="customContainer z-[1]">
          <div className="mb-20 text-center relative z-[3]">
            <a
              ...
              onClick={handleUpdateSinglepagePackagesTitles}
            >
              <HiPencil className=" bg-[#C7AC27] rounded-full  w-[25px] h-[25px] p-[5px] border-[1px] text-black" />
            </a>
            <p className="text-light">
              {singlepageTitlesData?.data?.[0]
                ?.singlepage_titles_packages_subtitle || "Subtitle"}
            </p>
            <h3 className="text-[clamp(20px,7vw,35px)] font-semibold leading-[1.1] text-light">
              {singlepageTitlesData?.data?.[0]
                ?.singlepage_titles_packages_title || "Title"}
            </h3>
          </div>
