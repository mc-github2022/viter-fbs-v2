...
const ModalUpdateSinglepageOverview = ({
  itemEdit,
  ...
  React.useEffect(() => {
    setAnimate("");
    if (singlepageOverviewData) {
      const clientPhotos = getConvertStringToJSONparseData(
        singlepageOverviewData?.data?.[0]?.singlepage_overview_file
      );
      setClientImages(clientPhotos);
    }
    if (singlepageOverviewData) {
      const logoPhotos = getConvertStringToJSONparseData(
        singlepageOverviewData?.data?.[0]?.singlepage_overview_img
      );
  ...
  const initVal = {
    ...
    singlepage_overview_subtitle:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_subtitle ?? "",
    singlepage_overview_title:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_title ?? "",
    singlepage_overview_button_text:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_button_text ?? "",
    singlepage_overview_img:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_img ?? "",
    singlepage_overview_file:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_file ?? "",

    singlepage_overview_img_old:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_img ?? "",
    singlepage_overview_file_old:
      singlepageOverviewData?.data?.[0]?.singlepage_overview_file ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                singlepage_overview_img: logoImages.map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                ),
                singlepage_overview_file: clientImages.map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="singlepage_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="singlepage_overview_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="singlepage_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateSinglepageOverview;
