...
const ModalUpdateImmersionOverview = ({ itemEdit, immersionOverviewData }) => {
  ...
  const initVal = {
    ...
    immersion_overview_img:
      immersionOverviewData?.data?.[0]?.immersion_overview_img ?? "",
    immersion_overview_file:
      immersionOverviewData?.data?.[0]?.immersion_overview_file ?? "",

    immersion_overview_img_old:
      immersionOverviewData?.data?.[0]?.immersion_overview_img ?? "",
    immersion_overview_file_old:
      immersionOverviewData?.data?.[0]?.immersion_overview_file ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                immersion_overview_img: logoImages.map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                ),
                immersion_overview_file: clientImages.map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="immersion_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="immersion_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateImmersionOverview;
