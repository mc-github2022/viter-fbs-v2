        ...
        <div className="customContainer max-w-[90%]">
            ...
            <div className="relative">
              <p>
                {continuingTitlesData?.data?.[0]
                  ?.continuing_titles_partnersays_subtitle || "Subtitle"}
              </p>
              <h2 className="text-[clamp(20px,7vw,35px)] font-semibold text-primary leading-[1.1] mb-8">
                {continuingTitlesData?.data?.[0]
                  ?.continuing_titles_partnersays_title || "Title"}
              </h2>
              <a
                className="absolute cursor-pointer tooltip-btn -top-4 left-[20rem] "
                data-tooltip="Edit contents"
                onClick={handleUpdateContinuingPartnerSaysTitle}
              >
          ...
          <div className="wrapper ">
            {IndtestimonialData?.data.filter(
              (item) =>
                item.industry_testimonial_category === "Continuing Studies"
            ).length > 1 ? (
...
export default ContinuingPartnerSays;
