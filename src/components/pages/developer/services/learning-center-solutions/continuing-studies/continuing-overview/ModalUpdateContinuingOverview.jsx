...
const ModalUpdateContinuingOverview = ({
  itemEdit,
  ...
  const initVal = {
    ...
    continuing_overview_subtitle:
      continuingOverviewData?.data?.[0]?.continuing_overview_subtitle ?? "",
    continuing_overview_title:
      continuingOverviewData?.data?.[0]?.continuing_overview_title ?? "",
    continuing_overview_button_text:
      continuingOverviewData?.data?.[0]?.continuing_overview_button_text ?? "",
    continuing_overview_img:
      continuingOverviewData?.data?.[0]?.continuing_overview_img ?? "",

    continuing_overview_img_old:
      continuingOverviewData?.data?.[0]?.continuing_overview_img ?? "",
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                continuing_overview_img: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="continuing_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="continuing_overview_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="continuing_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateContinuingOverview;
