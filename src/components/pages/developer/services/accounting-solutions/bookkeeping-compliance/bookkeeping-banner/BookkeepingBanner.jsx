  ...
  return (
    <>
      ...
      >
        ...
        bookkeepingBannerImage?.length > 0 ? (
          <>
            {bookkeepingBannerImage.map((img, index) => (
              <LoadImages
                url={`${googleHDViewLink}${img?.id}`}
                alt={`bookkeeping banner ${index + 1}`}
