...
const ModalUpdateBookkeepingOverview = ({
  itemEdit,
  ...
  const initVal = {
    ...
    bookkeeping_overview_img:
      bookkeepingOverviewData?.data?.[0]?.bookkeeping_overview_img ?? "",

    bookkeeping_overview_img_old:
      bookkeepingOverviewData?.data?.[0]?.bookkeeping_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                bookkeeping_overview_img: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="bookkeeping_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="bookkeeping_overview_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateBookkeepingOverview;
