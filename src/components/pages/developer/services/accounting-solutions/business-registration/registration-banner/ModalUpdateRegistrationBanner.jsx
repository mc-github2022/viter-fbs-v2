...
const ModalUpdateRegistrationBanner = ({ itemEdit, registrationData }) => {
    ...
    mutationFn: (values) =>
      queryData(
        registrationData?.data?.length
          ? `${apiVersion}/registration/${registrationData.data[0].registration_banner_aid}` // update
          : `${apiVersion}/registration`, // create
        registrationData?.data?.length ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Registration Banner
          </h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                registration_banner_img: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="pr-2 ">
                    ...
                    <div className="input-wrapper">
                      <InputTextArea
                        label="Title"
                        type="text"
                        name="registration_banner_title"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title Bold"
                        type="text"
                        name="registration_banner_title_bold"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper ">
                      <InputTextArea
                        label="Description"
                        type="text"
                        name="registration_banner_description"
                        className="h-[400px]"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="registration_banner_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div
...
export default ModalUpdateRegistrationBanner;
