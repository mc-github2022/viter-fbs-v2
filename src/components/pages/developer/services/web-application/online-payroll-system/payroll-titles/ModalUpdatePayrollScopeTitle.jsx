...
const ModalUpdatePayrollScopeTitle = ({ itemEdit, payrollTitlesData }) => {
  ...
  const initVal = {
    ...
    payroll_titles_overview_subtitle:
      payrollTitlesData?.data?.[0]?.payroll_titles_overview_subtitle ?? "",
    payroll_titles_overview_title:
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Payroll Overview Title
          </h2>
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="payroll_titles_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="payroll_titles_overview_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdatePayrollScopeTitle;
