...
const ModalUpdatePayrollPackagesTitle = ({ itemEdit, payrollTitlesData }) => {
  ...
  const initVal = {
    ...
    payroll_titles_packages_subtitle:
      payrollTitlesData?.data?.[0]?.payroll_titles_packages_subtitle ?? "",
    payroll_titles_packages_title:
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Payroll Packages Title
          </h2>
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="payroll_titles_packages_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="payroll_titles_packages_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdatePayrollPackagesTitle;
