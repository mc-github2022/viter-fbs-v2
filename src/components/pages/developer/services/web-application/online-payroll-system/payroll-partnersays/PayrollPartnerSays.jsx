  ...
  return (
    <>
      <section className="ServiceHrPartnersSay pb-10 md:py-20 ">
        <div className="customContainer max-w-[90%] relative">
          <a
            className="absolute cursor-pointer tooltip-btn left-[15rem] -top-2 "
            data-tooltip="Edit contents"
            onClick={handleUpdatePayrollTestimonialTitles}
          >
          ...
          {IndtestimonialData?.data.length > 0 && (
            <div className="">
              <p>
                ...
                payrollTitlesData.data[0]?.payroll_titles_testimonial_subtitle
                  ? payrollTitlesData?.data[0]
                      .payroll_titles_testimonial_subtitle
                  : "Subtitle"}
              </p>
              <h2 className="text-[clamp(20px,7vw,35px)] font-semibold text-primary leading-[1.1] mb-8">
                {payrollTitlesData?.data?.length > 0 &&
                payrollTitlesData.data[0]?.payroll_titles_testimonial_title
                  ? payrollTitlesData?.data[0].payroll_titles_testimonial_title
                  : "Title"}
              </h2>
            </div>
          ...
          <div className="wrapper ">
            {IndtestimonialData?.data.filter(
              (item) =>
                item.industry_testimonial_category === "Online Payroll System"
            ).length > 1 ? (
...
export default PayrollPartnerSays;
