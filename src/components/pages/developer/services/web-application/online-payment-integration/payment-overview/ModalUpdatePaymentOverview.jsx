...
const ModalUpdatePaymentOverview = ({ itemEdit, paymentOverviewData }) => {
  ...
  const initVal = {
    ...
    payment_overview_img:
      paymentOverviewData?.data?.[0]?.payment_overview_img ?? "",

    payment_overview_img_old:
      paymentOverviewData?.data?.[0]?.payment_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                payment_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="payment_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="payment_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdatePaymentOverview;
