...
const ModalUpdateHrisOverviewList = ({ itemEdit, hrisOverviewData }) => {
  ...
  const initVal = {
    ...
    hris_overview_list_title_a:
      hrisOverviewData?.data?.[0]?.hris_overview_list_title_a ?? "",
    hris_overview_list_description_a:
      hrisOverviewData?.data?.[0]?.hris_overview_list_description_a ?? "",
    hris_overview_list_title_b:
      hrisOverviewData?.data?.[0]?.hris_overview_list_title_b ?? "",
    hris_overview_list_description_b:
      hrisOverviewData?.data?.[0]?.hris_overview_list_description_b ?? "",
    hris_overview_list_title_c:
      hrisOverviewData?.data?.[0]?.hris_overview_list_title_c ?? "",
    hris_overview_list_description_c:
      hrisOverviewData?.data?.[0]?.hris_overview_list_description_c ?? "",
  };
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Title A"
                        type="text"
                        name="hris_overview_list_title_a"
                    ...
                    <div className="input-wrapper">
                      <InputTextArea
                        label="Description A"
                        type="text"
                        name="hris_overview_list_description_a"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputText
                        label="Title B"
                        type="text"
                        name="hris_overview_list_title_b"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputTextArea
                        label="Description B"
                        type="text"
                        name="hris_overview_list_description_b"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputText
                        label="Title C"
                        type="text"
                        name="hris_overview_list_title_c"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputTextArea
                        label="Description C"
                        type="text"
                        name="hris_overview_list_description_c"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateHrisOverviewList;
