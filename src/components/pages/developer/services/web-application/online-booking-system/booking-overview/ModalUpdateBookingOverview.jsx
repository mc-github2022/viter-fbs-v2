...
const ModalUpdateBookingOverview = ({ itemEdit, bookingOverviewData }) => {
  ...
  const initVal = {
    ...
    booking_overview_img:
      bookingOverviewData?.data?.[0]?.booking_overview_img ?? "",

    booking_overview_img_old:
      bookingOverviewData?.data?.[0]?.booking_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                booking_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  }),
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="booking_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="booking_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateBookingOverview;
