...
const AssetScope = ({
  handleUpdateAssetScopeTitles,
  handleUpdateAssetScope,
  isLoadingScope,
  isFetchingScope,
  setItemEdit,
  assetTitlesData,
  ...
  const handleDelete = (scopeList) => {
    ...
    setIsData(scopeList.asset_scope_title);
    setIsId(scopeList.asset_scope_aid);
  };
    ...
    <>
        ...
        <div className="customContainer relative">
          <div className="relative">
            <a
              ...
              onClick={handleUpdateAssetScopeTitles}
            >
          ...
          <a
            ...
            onClick={handleUpdateAssetScope}
          >
          ...
          {(isLoadingScope || assetScopeData?.data?.length === 0) && (
      ...
      {store.isDelete && (
        <ModalDelete
          ...
          queryKey={"asset-scope"}
          mysqlEndpoint={`/v1/asset-scope/${id}`}
          item={isData}
        />
      )}
