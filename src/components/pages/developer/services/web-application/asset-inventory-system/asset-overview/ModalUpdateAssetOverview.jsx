...
const ModalUpdateAssetOverview = ({ itemEdit, assetOverviewData }) => {
  ...
  const initVal = {
    ...
    asset_overview_subtitle:
      assetOverviewData?.data?.[0]?.asset_overview_subtitle ?? "",
    asset_overview_title:
      assetOverviewData?.data?.[0]?.asset_overview_title ?? "",
    asset_overview_button_text:
      assetOverviewData?.data?.[0]?.asset_overview_button_text ?? "",
    asset_overview_img: assetOverviewData?.data?.[0]?.asset_overview_img ?? "",

    asset_overview_img_old:
      assetOverviewData?.data?.[0]?.asset_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                asset_overview_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="asset_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateAssetOverview;
