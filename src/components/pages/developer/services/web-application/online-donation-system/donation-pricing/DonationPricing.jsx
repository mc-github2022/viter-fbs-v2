...
const DonationPricing = ({
  ...
  const selectedCategory =
    packagesListData?.data?.find(
      (item) => item.packages_category_url === "webapp-onlinedonation"
    )?.packages_category_url || "webapp-onlinedonation";
        ...
        <div className="customContainer z-[1]">
          <div className="mb-20 text-center relative z-[3]">
            <a
              ...
              onClick={handleUpdateDonationPackagesTitles}
            >
...
export default DonationPricing;
