  ...
  return (
    <>
      ...
      >
        ...
        enrollmentBannerImage?.length > 0 ? (
          <>
            {enrollmentBannerImage.map((img, index) => (
              <LoadImages
                url={`${googleHDViewLink}${img?.id}`}
                alt={`enrollment banner ${index + 1}`}
