...
const EnrollmentScope = ({
  ...
  const handleDelete = (scopeList) => {
    ...
    setIsData(scopeList.enrollment_scope_title);
    setIsId(scopeList.enrollment_scope_aid);
  };
    ...
    <>
        ...
        <div className="customContainer relative">
          <div className="relative">
            <a
              ...
              onClick={handleUpdateEnrollmentScopeTitles}
            >
          ...
          <a
            ...
            onClick={handleUpdateEnrollmentScope}
          >
          ...
          {(isLoadingScope || enrollmentScopeData?.data?.length === 0) && (
      ...
      {store.isDelete && (
        <ModalDelete
          ...
          queryKey={"enrollment-scope"}
          mysqlEndpoint={`/v1/enrollment-scope/${id}`}
          item={isData}
        />
      )}
...
export default EnrollmentScope;
