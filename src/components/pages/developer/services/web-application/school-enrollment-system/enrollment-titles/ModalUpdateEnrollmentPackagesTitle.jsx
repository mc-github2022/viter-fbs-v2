...
const ModalUpdateEnrollmentPackagesTitle = ({
  itemEdit,
  ...
  const initVal = {
    ...
    enrollment_titles_packages_subtitle:
      ...
      "",
    enrollment_titles_packages_title:
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Enrollment Packages Title
          </h2>
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="enrollment_titles_packages_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="enrollment_titles_packages_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateEnrollmentPackagesTitle;
