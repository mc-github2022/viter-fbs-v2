...
const ModalUpdateEnrollmentPartnerSaysTitle = ({
  itemEdit,
  ...
  const initVal = {
    ...
    enrollment_titles_testimonial_subtitle:
      enrollmentTitlesData?.data?.[0]?.enrollment_titles_testimonial_subtitle ??
      "",
    enrollment_titles_testimonial_title:
      enrollmentTitlesData?.data?.[0]?.enrollment_titles_testimonial_title ??
      "",
  };
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Enrollment Testimonial Title
          </h2>
                  ...
                  <div className="form-input ">
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="enrollment_titles_testimonial_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="enrollment_titles_testimonial_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateEnrollmentPartnerSaysTitle;
