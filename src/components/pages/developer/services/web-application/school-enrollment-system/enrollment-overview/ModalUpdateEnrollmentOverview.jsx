...
const ModalUpdateEnrollmentOverview = ({
  itemEdit,
  ...
  const initVal = {
    ...
    enrollment_overview_subtitle:
      enrollmentOverviewData?.data?.[0]?.enrollment_overview_subtitle ?? "",
    enrollment_overview_title:
      enrollmentOverviewData?.data?.[0]?.enrollment_overview_title ?? "",
    enrollment_overview_button_text:
      enrollmentOverviewData?.data?.[0]?.enrollment_overview_button_text ?? "",
    enrollment_overview_img:
      enrollmentOverviewData?.data?.[0]?.enrollment_overview_img ?? "",

    enrollment_overview_img_old:
      enrollmentOverviewData?.data?.[0]?.enrollment_overview_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                enrollment_overview_img: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Subtitle"
                        type="text"
                        name="enrollment_overview_subtitle"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Title"
                        type="text"
                        name="enrollment_overview_title"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
                      <InputText
                        label="Button"
                        type="text"
                        name="enrollment_overview_button_text"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateEnrollmentOverview;
