            ...
            return (
              <Form>
                <div className="flex gap-10 ">
                  ...
                  <div className="w-[75%]">
                    <div className="Preview md:min-h-[calc(86vh-55px)] lg:max-h-[calc(100vh-150px)] w-full border-[2px] border-gray-200 flex justify-center items-center rounded-lg mt-3">
                      {values.sending_email_log_content ? (
                        <div className="w-full">
                          <iframe
                            srcDoc={values.sending_email_log_content}
                            className="md:min-h-[calc(81vh-35px)] lg:max-h-[calc(90vh-150px)] border-none w-full"
                          />
                        </div>
                      ) : (
