...
const ModalAddGallery = ({ setIsAdd, itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v1/gallery/${itemEdit.gallery_aid}` // update
          : `/v1/gallery`, // create
        itemEdit ? "put" : "post",
        values
      ),
  ...
  const initVal = {
    gallery_img: itemEdit ? itemEdit.gallery_img : "",

    gallery_img_old: itemEdit ? itemEdit.gallery_img : "",
    pendingDeleteFile: [],
  };
    ...
    <>
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">{itemEdit ? "Edit" : "Add"} Photo</h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                gallery_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                ...
                <Form className="modal-form">
                  <div className="form-input">
                    <div className="input-wrapper place-self-center">
                      ...
                      <div
                        className={`relative mt-4 mb-4 border border-gray-300 rounded-md place-self-center hover:border-primary hover:border-dashed w-[300px] text-xs ${
