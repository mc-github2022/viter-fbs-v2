...
const ModalUpdateWorkTeamsMarketing = ({ itemEdit, workTeamsData }) => {
  ...
  const initVal = {
    ...
    work_teams_marketing_name:
      workTeamsData?.data?.[0]?.work_teams_marketing_name ?? "",
    work_teams_marketing_position:
      workTeamsData?.data?.[0]?.work_teams_marketing_position ?? "",
    work_teams_marketing_img:
      workTeamsData?.data?.[0]?.work_teams_marketing_img ?? "",

    work_teams_marketing_img_old:
      workTeamsData?.data?.[0]?.work_teams_marketing_img ?? "",
    pendingDeleteFile: [],
  };
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">
            {itemEdit ? "Edit" : "Add"} Marketing Head
          </h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                work_teams_marketing_img: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input ">
                    <div className="mt-3">
                      ...
                      >
                        ...
                        <InputFileUpload
                          label="Upload teams_marketing Image"
                          name="File"
                          type="file"
                          id="myFile"
                          accept="*"
                    ...
                    <div className="input-wrapper">
                      <InputTextArea
                        label="Name"
                        type="text"
                        name="work_teams_marketing_name"
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Position"
                        type="text"
                        name="work_teams_marketing_position"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWorkTeamsMarketing;
