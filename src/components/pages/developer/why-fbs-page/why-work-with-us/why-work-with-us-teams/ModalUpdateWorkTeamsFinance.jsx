...
const ModalUpdateWorkTeamsFinance = ({ itemEdit, workTeamsData }) => {
  ...
  const initVal = {
    ...
    work_teams_finance_name:
      workTeamsData?.data?.[0]?.work_teams_finance_name ?? "",
    work_teams_finance_position:
      workTeamsData?.data?.[0]?.work_teams_finance_position ?? "",
    work_teams_finance_img:
      workTeamsData?.data?.[0]?.work_teams_finance_img ?? "",

    work_teams_finance_img_old:
      workTeamsData?.data?.[0]?.work_teams_finance_img ?? "",
    pendingDeleteFile: [],
  };
    ...
    <>
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">{itemEdit ? "Edit" : "Add"} Finance Head</h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                work_teams_finance_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
                  ...
                  <div className="form-input ">
                    ...
                    <div className="input-wrapper">
                      <InputText
                        label="Position"
                        type="text"
                        name="work_teams_finance_position"
                        disabled={mutation.isPending}
                      />
                    </div>
                  </div>
...
export default ModalUpdateWorkTeamsFinance;
