...
const ModalUpdateWorkTeamsHr = ({ itemEdit, workTeamsData }) => {
  ...
  const initVal = {
    ...
    work_teams_hr_name: workTeamsData?.data?.[0]?.work_teams_hr_name ?? "",
    work_teams_hr_position:
      workTeamsData?.data?.[0]?.work_teams_hr_position ?? "",
    work_teams_hr_img: workTeamsData?.data?.[0]?.work_teams_hr_img ?? "",

    work_teams_hr_img_old: workTeamsData?.data?.[0]?.work_teams_hr_img ?? "",
    pendingDeleteFile: [],
  };
    ...
    <>
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">{itemEdit ? "Edit" : "Add"} HR Manager</h2>
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                work_teams_hr_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
...
export default ModalUpdateWorkTeamsHr;
