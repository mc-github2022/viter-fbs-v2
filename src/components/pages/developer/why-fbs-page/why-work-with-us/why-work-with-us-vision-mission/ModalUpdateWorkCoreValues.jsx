...
const ModalUpdateWorkCoreValues = ({ itemEdit, workVisionMissionData }) => {
    ...
    <>
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">{itemEdit ? "Edit" : "Add"} Core Values</h2>
...
export default ModalUpdateWorkCoreValues;
