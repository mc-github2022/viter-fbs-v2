...
const ModalUpdateWorkVision = ({ itemEdit, workVisionMissionData }) => {
    ...
    <>
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">{itemEdit ? "Edit" : "Add"} Vision</h2>
...
export default ModalUpdateWorkVision;
