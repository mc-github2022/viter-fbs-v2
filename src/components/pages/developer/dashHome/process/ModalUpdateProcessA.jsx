...
const ModalUpdateProcessA = ({ itemEdit, processData }) => {
  ...
  const initVal = {
    ...
    process_title_a: processData?.data?.[0]?.process_title_a ?? "",
    process_description_a: processData?.data?.[0]?.process_description_a ?? "",
  };
...
export default ModalUpdateProcessA;
