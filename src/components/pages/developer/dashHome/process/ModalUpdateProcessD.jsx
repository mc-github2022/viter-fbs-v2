...
const ModalUpdateProcessD = ({ itemEdit, processData }) => {
  ...
  const initVal = {
    ...
    process_title_d: processData?.data?.[0]?.process_title_d ?? "",
    process_description_d: processData?.data?.[0]?.process_description_d ?? "",
  };
...
export default ModalUpdateProcessD;
