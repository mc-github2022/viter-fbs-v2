                          ...
                          >
                            {insightsImages.map((image, index) => (
                              <div
                                ...
                                className="blogItem bg-center bg-cover md:w-[360px] h-[350px] flex items-end relative rounded-xl grayscale hover:grayscale-0 transition-all group cursor-pointer place-self-center"
                                key={index}
                              >
                                <div>
