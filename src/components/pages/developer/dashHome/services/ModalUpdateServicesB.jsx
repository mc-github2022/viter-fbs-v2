...
const ModalUpdateServicesB = ({ itemEdit, servicesData }) => {
  ...
  const initVal = {
    ...
    services_title_b: servicesData?.data?.[0]?.services_title_b ?? "",
    services_description_b:
      servicesData?.data?.[0]?.services_description_b ?? "",
    services_button_text_b:
      servicesData?.data?.[0]?.services_button_text_b ?? "",
    services_button_link_b:
      servicesData?.data?.[0]?.services_button_link_b ?? "",
  };
...
export default ModalUpdateServicesB;
