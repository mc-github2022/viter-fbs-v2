...
const ModalUpdateServicesC = ({ itemEdit, servicesData }) => {
  ...
  const initVal = {
    ...
    services_title_c: servicesData?.data?.[0]?.services_title_c ?? "",
    services_description_c:
      servicesData?.data?.[0]?.services_description_c ?? "",
    services_button_text_c:
      servicesData?.data?.[0]?.services_button_text_c ?? "",
    services_button_link_c:
      servicesData?.data?.[0]?.services_button_link_c ?? "",
  };
...
export default ModalUpdateServicesC;
