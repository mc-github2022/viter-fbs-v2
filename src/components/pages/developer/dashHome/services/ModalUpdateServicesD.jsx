...
const ModalUpdateServicesD = ({ itemEdit, servicesData }) => {
  ...
  const initVal = {
    ...
    services_title_d: servicesData?.data?.[0]?.services_title_d ?? "",
    services_description_d:
      servicesData?.data?.[0]?.services_description_d ?? "",
    services_button_text_d:
      servicesData?.data?.[0]?.services_button_text_d ?? "",
    services_button_link_d:
      servicesData?.data?.[0]?.services_button_link_d ?? "",
  };
...
export default ModalUpdateServicesD;
