...
(18, 'College On-the-job Training', 'https://www.youtube.com/watch?v=7fGYHbtnCQk', '[{\"name\":\"lc.png\",\"id\":\"1R9ode7wg3kiwJdy5JNntAVjvbVS-1CBz\",\"datetime\":\"2025-03-24 09:31:24\"}]', 'Aileah Marie Lozada', 'Laguna College Trainee', '', 'They did not just help me improve my web designing skills, but they also gave me strength and advises regarding personality and values that I can adopt from them to the IT industry.', '2025-03-24 09:31:21', '2025-03-24 09:31:21');
...
--
ALTER TABLE `fbsv2_vid_testimonial`
  MODIFY `vid_testimonial_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
