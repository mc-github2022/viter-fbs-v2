...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2025 at 08:40 AM
...
CREATE TABLE `fbsv2_events_activities` (
  ...
  `events_activities_img` text NOT NULL,
...
(28, 1, '[{\"name\":\"accounting-associate-300x198 - Copy.png\",\"id\":\"1NHFvghTjOVDVlVAjK6IqELMEDeMN1o8Q\",\"datetime\":\"2025-03-20 14:10:32\"}]', '[{\"name\":\"b65-1.webp\",\"id\":\"1LzmWE1YLhY08yKyc6covKX6L4sCpqYzQ\",\"datetime\":\"2025-03-20 14:47:39\"}]', 'Test Events and Activities', 'Testing ito', 'Test Events and Activities', '2025-03-20', 'Testing events and acts', '2025-03-20 14:10:29', '2025-03-20 15:03:25');
...
--
ALTER TABLE `fbsv2_events_activities`
  MODIFY `events_activities_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
