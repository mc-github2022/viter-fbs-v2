...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2024 at 08:17 AM
...
VALUES
  (
    ...
    'Virtual Assistant',
    'Maximizing Productivity with Virtual Assistant Services: Your Secret to Streamlining Success',
    'maximizing-productivity-with-virtual-assistant-services',
    '2024-10-26',
  ...
  (
    ...
    'web-developer-2.jpg',
    'Web Development',
    'Why website maintenance is crucial for any business',
    'why-website-maintenance-is-crucial-for-any-business',
    '2024-10-25',
  ...
  (
    ...
    'learning.jpg',
    'Skills Development',
    'Soft Skills that Set Students Apart',
    'soft-skills-thats-set-students-apart',
    '2024-10-25',
...
INSERT INTO
  `fbsv2_home_testimonial` (
    `home_testimonial_aid`,
    `home_testimonial_message`,
    `home_testimonial_name`,
    `home_testimonial_position`,
    `home_testimonial_client_img`,
    `home_testimonial_logo_img`,
    `home_testimonial_created`,
    `home_testimonial_datetime`
  )
VALUES
  (
    12,
    'FBS is a true partner to our firm. They have helped form our vision and trajectory. We are immensely grateful for our partnership. Our expectation is for FBS to grow with us. They are an important part of our success. And beyond the business perspective, they are fantastic people. We are blessed to work with them.',
    'Robert Han',
    'COO / Partner',
    'testimonial-robert-han-2-img.png',
    'tm_logo_white.png',
    '0000-00-00 00:00:00',
    '2024-10-30 09:15:52'
  ),
  (
    13,
    'Frontline has been an incredible organization to work with.  They are friendly, accommodating, and professional, but what stands out most is how responsive they are.  When I have a problem or request, I don’t think there has been a single time that not only have I received a response within the day, but whatever it was that I needed, their team has met that need within the day as well. I would highly recommend working with them.',
    'Duane Masters',
    'Executive Director',
    'testi-duane-masters-2.png',
    'world-focus-home.png',
    '0000-00-00 00:00:00',
    '2024-10-30 09:17:31'
  ),
  (
    14,
    'We love working with FBS because they go the extra mile in doing the work. It’s nice to work with people who have the heart to serve. A mutually respecting relationship.',
    'Hiro Isogawa',
    'CEO, CPA, Partner',
    'testimonial-hiro-isogawa-2.png',
    'tm_logo_white.png',
    '0000-00-00 00:00:00',
    '2024-10-30 09:22:15'
  ),
...
INSERT INTO
  `fbsv2_industry_testimonial` (
    `industry_testimonial_aid`,
    `industry_testimonial_img`,
    `industry_testimonial_logo`,
    `industry_testimonial_name`,
    `industry_testimonial_position`,
    `industry_testimonial_message`,
    `industry_testimonial_category`,
    `industry_testimonial_company`,
    `industry_testimonial_created`,
    `industry_testimonial_datetime`
  )
VALUES
  (
    1,
  ...
  (
    4,
    'judea-delos-santos.png',
    'ftc-logo.png',
    'Judea Delos Santos',
    'Asst. Managing Director / Comm. & Dev. Staff',
  ...
  (
    ...
    'logo-pfm.png',
    'Bethany P. Acoba',
    'Donor Communications and Care Coordinator',
  ...
  (
    ...
    'Ms. Olivia Almarez',
    'OJT Coordinator',
    'Frontline Business Solution has been one of STI San Pablo\'s most trusted partners for several years. We at STI are truly grateful for the exceptional knowledge and experience FBS has provided to our On-the-Job trainee students in IT and Engineering, as well as for the kindness and support shown coming from the people of FBS.',
    'College On-the-job- Training',
    'STI San Pablo Campus',
    '2024-11-04 13:15:14',
    '2024-11-04 13:15:14'
  ),
  (
    8,
    'angelou-almare-medina.png',
    'sti.png',
    'Mrs. Angelou Almare-Medina',
    '',
    'FBS\' internship program provided great opportunity for students to experience actual industry-related tasks which greatly honed their skills. This also enhanced their professional capabilities and served as a valuable foundation for their future career.',
    'College On-the-job- Training',
    'STI San Pablo Campus',
    '2024-11-04 13:16:32',
    '2024-11-04 13:16:32'
  ...
  (
    ...
    'kevinroy-nativo.png',
    'aclc.png',
    'Mr. Kevin Roy N. Oreña',
    'Freelancer',
    'After graduating 5 years ago, I didn\'t have the chance to apply my programming skills in my career. So, I decided to further my studies at FBS. Through FBS, I was able to refresh my existing knowledge and acquire new skills in web development, including HTML/CSS, SASS, Tailwind, Figma, WordPress, and JavaScript, which I have already been using in my freelancing career.',
    'Continuing Studies',
    '',
    '2024-11-04 13:20:11',
    '2024-11-04 13:20:11'
  ...
  (
    ...
    'Jake Ansel Gamaro',
    'Freelancer',
    'The immersion program was incredibly beneficial for me. I loved diving into front-end web development, learning tools like Figma for prototyping and web designing, and exploring CSS with SASS and Tailwind. Getting hands-on experience with WordPress really boosted my confidence. I’m thankful for the supportive instructors and the skills I gained for my career!',
    'Continuing Studies',
    '',
    '0000-00-00 00:00:00',
    '2024-11-04 13:22:35'
  ...
  (
    14,
    'joesua-manzanero.png',
    'lspu.png',
    'Joesua R. Manzanero',
    'Faculty, Program Coordinator, BS in Information Technology  OJT Coordinator, College of Computer Studies',
  ...
  (
    ...
    'jcceos-logo.png',
    'Teresa Heyne',
    'Overseer, Director of Operations',
  ...
  (
    ...
    'Kurt Lui Balanial',
    'BSCpE Batch 2024 Pamantasan ng Lungsod ng San Pablo',
    'My training at Frontline Business Solutions was an invaluable experience that equipped me with essential skills in HTML, CSS, and Java. The supportive and professional environment made me feel empowered and ready to take on future challenges in the industry. This experience has truly prepared me for my career endeavors, leaving me more confident in my abilities.',
    'Continuing Studies',
    '',
    '0000-00-00 00:00:00',
    '2024-11-05 12:14:58'
...
VALUES
  (
    ...
    'Laguna College',
    'BS Computer Science',
    '2016405112148.webp, dsc_0001-1.webp, dsc_0002-2.webp, dsc_0005-5.webp',
    '0000-00-00 00:00:00',
    '2024-11-04 12:15:15'
  ),
  (
    ...
    '13487284_1379426098750714_109717399_n.webp',
    '2024-11-04 12:19:08',
    '2024-11-04 12:19:08'
  ),
  (
    ...
    'college.webp, college-3.jpg, img_5234.webp, img_5345.webp, img_5389.webp, img_5391.webp, img_5393.webp, img_5396.webp, img_5398.webp, img_5401.webp',
    '2024-11-04 12:34:11',
    '2024-11-04 12:34:11'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'immersion-60.webp, immersion-61.webp, immersion-62.webp, immersion-63.webp, immersion-64.webp, immersion-65.webp, immersion-81.webp, immersion-83.webp',
    '2024-11-04 12:40:22',
    '2024-11-04 12:40:22'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'img_1450.webp, img_1451.webp, img_1452.webp, img_1453.webp, img_1454.webp, img_1455.webp, img_1456.webp, img_1457.webp',
    '2024-11-04 12:49:44',
    '2024-11-04 12:49:44'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b6-1.webp, b6-2.webp, b6-3.webp, b6-4.webp, b6-5.webp, b6-6.webp, b6-7.webp, b6-8.webp, b6-9.webp',
    '0000-00-00 00:00:00',
    '2024-11-04 13:17:33'
  ),
  (
    ...
    'Batch 7',
    'High School Work Immersion',
    'San Pablo Colleges & ACLC San Pablo',
    'STEM',
    'b7-1.webp, b7-2.webp, b7-3.webp, b7-4.webp, b7-5.webp, b7-6.webp, b7-7.webp, b7-8.webp',
    '0000-00-00 00:00:00',
    '2024-11-04 14:31:55'
  ),
  (
    ...
    'Batch 8',
    'College On-the-job Training',
    'Laguna State Polytechnic Univ. - SPC Campus',
    'BS Information Technology',
  ...
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b1.webp, b1-5.webp, b1-new-4.webp, b1-new-11.webp, b9-1.webp, b9-2.webp, image1.webp, image2.webp, img_0036.webp, img_0040.webp, img_0061.webp, img_0068.webp',
    '2024-11-04 15:07:16',
    '2024-11-04 15:07:16'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b10-1.webp, b10-2.webp, b10-3.webp, b10-4.webp, b10-5.webp, b10-6.webp, b10-7.webp, b10-8.webp, b10-9.webp',
    '0000-00-00 00:00:00',
    '2024-11-04 15:14:38'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b11-1.webp, b11-2.webp, b11-3.webp, b11-4.webp, b11-5.webp, b11-6.webp, b11-7.webp, b11-8.webp, b11-9.webp, b11-10.webp',
    '2024-11-04 15:29:25',
    '2024-11-04 15:29:25'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'batch-8.webp, batch-8-1.webp, batch-8-2.webp, batch-8-3.webp, batch-8-5.webp, batch-8-7.webp, batch-8-8.webp, batch-8-9.webp',
    '2024-11-04 15:34:25',
    '2024-11-04 15:34:25'
  ),
  (
    ...
    'ABM',
    'gva1.webp, gva2.webp, gva3.webp, gva4.webp, gva5.webp, gva6.webp, gva7.webp',
    '2024-11-04 15:44:20',
    '2024-11-04 15:44:20'
  ),
  (
    ...
    'St. Therese Montessori School',
    'ABM',
    'st.therese.webp, st.therese-2.webp',
    '2024-11-04 15:49:15',
    '2024-11-04 15:49:15'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'batch15-1.webp, batch15-2.webp, batch15-3.webp, batch15-4.webp, batch15-5.webp, batch15-6.webp, batch15-7.webp',
    '2024-11-05 10:38:50',
    '2024-11-05 10:38:50'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'batch16-1.webp, batch16-2.webp, batch16-3.webp, batch16-4.webp, batch16-5.webp, batch16-6.webp, batch16-7.webp',
    '0000-00-00 00:00:00',
    '2024-11-05 10:46:17'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b20-1.webp, b20-2.webp, b20-3.webp, b20-4.webp, b20-5.webp, b20-6.webp',
    '2024-11-05 11:18:57',
    '2024-11-05 11:18:57'
  ),
  (
  ...
  (
    ...
    'Laguna State Polytechnic Univ. - SPC Campus',
    'BS Computer Engineering',
    'b22-1.webp, b22-2.webp, b22-3.webp',
    '2024-11-05 11:27:36',
    '2024-11-05 11:27:36'
  ),
  (
    ...
    'Batch 25',
    'College On-the-job Training',
    'Cavite State Univ., PLSP, and Mariano Marcos Univ.',
    'BS Computer Engineering & BS Computer Science',
    'b25-1.webp, b25-2.webp, b25-3.webp, b25-4.webp',
    '2024-11-05 11:43:53',
    '2024-11-05 11:43:53'
  ),
  (
  ...
  (
    ...
    'Batch 27',
    'College On-the-job Training',
    'STI College San Pablo & Batangas',
    'BS Information Technology',
    'b27.webp',
    '2024-11-05 11:49:14',
    '2024-11-05 11:49:14'
  ...
  (
    ...
    'College On-the-job Training',
    'ACLC - San Pablo',
    'BS Information Tecnhnology',
    'b28-1.webp, b28-2.webp',
    '2024-11-05 11:51:58',
    '2024-11-05 11:51:58'
  ),
  (
    ...
    'Batch 29',
    'College On-the-job Training',
    'Teodoro Luansing College, Batangas State Univ., and Laguna State Polytechnic Univ. - SPC Campus',
    'BS Information Technology',
    'b29-1.webp, b29-2.webp, b29-3.webp, b29-4.webp, b29-5.webp',
    '0000-00-00 00:00:00',
    '2024-11-05 11:58:31'
  ),
  (
    ...
    'Batch 30',
    'College On-the-job Training',
    'LSPU, Letran Calamba, Univ. of Batangas',
    'BS Information Technology and BS Computer Engineering',
    'b30-1.webp, b30-2.webp, b30-3.webp, b30-4.webp, b30-5.webp, b30-6.webp, b30-7.webp, b30-8.webp, b30-9.webp, b30-10.webp',
    '0000-00-00 00:00:00',
    '2024-11-05 12:13:06'
  ),
  (
  ...
  (
    ...
    'Batch 32',
    'High School Work Immersion',
    'Marcelino Fule Memo. College and San Pablo Colleges',
    'ICT',
    'img-0435.webp, img-0442.webp, img-0444.webp, img-0448.webp, img-0452.webp, img-0468.webp, img-0472.webp',
    '2024-11-05 12:30:34',
    '2024-11-05 12:30:34'
  ),
  (
    ...
    'Marcelino Fule Memo. College and San Pablo Colleges',
    'ICT',
    'b33-1.webp, b33-2.webp, b33-3.webp, b33-4.webp, b33-5.webp',
    '2024-11-05 12:53:46',
    '2024-11-05 12:53:46'
  ),
  (
    ...
    'Batch 34',
    'College On-the-job Training',
    'PUP - Sta. Mesa, and LPU - Manila',
    'BS Management Accounting and BS Accountancy',
    'b34-1.webp, b34-2.webp',
    '2024-11-05 13:03:52',
    '2024-11-05 13:03:52'
  ),
  (
    ...
    'Batch 35',
    'High School Work Immersion',
    'Marcelino Fule Memo. College',
    'HUMSS',
    'b35-1.webp, b35-2.webp, b35-3.webp, b35-4.webp, b35-5.webp, b35-6.webp, b35-7.webp, b35-8.webp, b35-9.webp, b35-10.webp',
    '2024-11-05 13:10:18',
    '2024-11-05 13:10:18'
  ),
  (
    ...
    'Batch 36',
    'College On-the-job Training',
    'PUP - Lopez Quezon and STI College San Pablo',
    'BS Information Technology',
    'b36-1.webp, b36-2.webp, b36-3.webp, b36-4.webp, b36-5.webp, b36-6.webp, b36-7.webp, b36-8.webp, b36-9.webp, b36-10.webp, b36-11.webp, b36-12.webp, b36-13.webp, b36-14.webp',
    '2024-11-05 13:20:33',
    '2024-11-05 13:20:33'
  ),
  (
    ...
    'ACLC San Pablo',
    'ABM',
    'b37-1.webp, b37-2.webp, b37-3.webp, b37-4.webp, b37-5.webp',
    '2024-11-05 13:23:42',
    '2024-11-05 13:23:42'
  ),
  (
    ...
    'Laguna College',
    'BS Computer Science',
    'b38-5.webp, b38-6.webp, b38-7.webp, b38-8.webp, b38-9.webp, b38-10.webp',
    '0000-00-00 00:00:00',
    '2024-11-05 13:37:32'
  ),
  (
    ...
    'BS Computer Engineering',
    'b38-1.webp, b38-2.webp, b38-3.webp, b38-4.webp',
    '2024-11-05 13:38:54',
    '2024-11-05 13:38:54'
  ),
  (
    ...
    'De La Salle - Lipa',
    'BS Computer Engineering',
    'b40-1.webp, b40-2.webp, b40-3.webp, b40-4.webp, b40-5.webp, b40-6.webp, b40-7.webp, b40-8.webp, b40-9.webp, b40-10.webp, b40-11.webp, b40-12.webp, b40-13.webp, b40-14.webp, b40-15.webp',
    '0000-00-00 00:00:00',
    '2024-11-05 14:48:52'
  ),
  (
  ...
  (
    ...
    'Pamantasan ng Lungsod ng San Pablo',
    'BS Computer Engineering',
    'b43-1.webp, b43-2.webp, b43-3.webp, b43-4.webp, b43-5.webp, b43-6.webp, b43-7.webp',
    '2024-11-05 14:57:28',
    '2024-11-05 14:57:28'
  ),
  (
  ...
  (
    ...
    'STEM, HUMSS, and ABM',
    'b47-0.webp, b47-1.webp, b47-2.webp, b47-3.webp, b47-4.webp, b47-5.webp, b47-6.webp, b47-6-2.webp, b47-7.webp, b47-8.webp, b47-9.webp, b47-10.webp',
    '2024-11-05 15:55:36',
    '2024-11-05 15:55:36'
  ),
  (
    ...
    'Batch 51',
    'College On-the-job Training',
    'DLSU - Lipa, Letran Calamba , and STI San Pablo',
    'BS Computer Science and BS Information Technology',
    'b51-1.webp, b51-2.webp, b51-3.webp, b51-4.webp, b51-5.webp, b51-6.webp, b51-7.webp, b51-8.webp, b51-9.webp',
    '2024-11-05 15:57:35',
    '2024-11-05 15:57:35'
  ),
  (
    ...
    'Greenville Academy of Sta. Clara',
    'STEM',
    'b52-0.webp, b52-1.webp, b52-2.webp, b52-3.webp, b52-4.webp, b52-5.webp, b52-10.webp, b52-11.webp, b52-12.webp, b52-15.webp, b52-17.webp, b52-21.webp, b52-22.webp',
    '2024-11-06 08:10:03',
    '2024-11-06 08:10:03'
  ),
  (
    ...
    'Greenville Academy of Sta. Clara',
    'STEM',
    'b53-1.webp, b53-2.webp, b53-3.webp',
    '2024-11-06 08:38:02',
    '2024-11-06 08:38:02'
  ),
  (
    ...
    'St. Therese Montessori School',
    'ABM',
    'b54-1.webp, b54-2.webp, b54-3.webp, b54-4.webp',
    '2024-11-06 08:54:13',
    '2024-11-06 08:54:13'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b55-0.webp, b55-1.webp, b55-2.webp, b55-3.webp, b55-4.webp, b55-5.webp, b55-6.webp, b55-7.webp',
    '2024-11-06 09:37:37',
    '2024-11-06 09:37:37'
  ),
  (
    ...
    'San Pablo Colleges',
    'ICT',
    'b56-1.webp, b56-2.webp, b56-3.webp, b56-4.webp, b56-5.webp, b56-6.webp, b56-7.webp, b56-8.webp, b56-9.webp, b56-10.webp, b56-11.webp',
    '2024-11-06 09:51:42',
    '2024-11-06 09:51:42'
  ),
  (
    ...
    'St. Therese Montessori School',
    'ABM',
    'b57-1.webp, b57-2.webp, b57-3.webp, b57-4.webp, b57-5.webp, b57-6.webp',
    '2024-11-06 09:59:17',
    '2024-11-06 09:59:17'
  ),
  (
  ...
  (
    ...
    'LSPU and ACLC',
    'BS Information Technology',
    'b60-1.webp, b60-2.webp, b60-3.webp',
    '0000-00-00 00:00:00',
    '2024-11-06 10:24:12'
  ),
  (
    ...
    'Laguna College',
    'BS Computer Science',
    'b61-1.webp, b61-2.webp, b61-3.webp, b61-4.webp, b61-5.webp, b61-6.webp, b61-7.webp',
    '2024-11-06 10:25:01',
    '2024-11-06 10:25:01'
  ),
  (
    ...
    'BS Computer Engineering',
    'b62-1.webp, b62-2.webp, b62-3.webp, b62-4.webp',
    '0000-00-00 00:00:00',
    '2024-11-06 10:30:01'
  ),
  (
    ...
    'BS Computer Engineering',
    'b63-1.webp, b63-2.webp, b63-3.webp, b63-4.webp, b63-5.webp, b63-6.webp',
    '2024-11-06 10:40:10',
    '2024-11-06 10:40:10'
  ),
  (
    ...
    'Laguna State Polytechnic Univ. - SPC Campus',
    'BS Computer Science',
    'b65-1.webp, b65-2.webp, b65-3.webp, b65-4.webp, b65-5.webp, b65-6.webp',
    '2024-11-06 11:48:05',
    '2024-11-06 11:48:05'
  ),
  (
    ...
    'Batch 66',
    'Continuing Studies',
    'PLSP and Laguna College',
    'BSCpE and BSCS',
    'b66-1.webp, b66-2.webp, b66-3.webp, b66-4.webp, b66-5.webp, b66-6.webp',
    '2024-11-06 11:52:46',
    '2024-11-06 11:52:46'
  );
...
INSERT INTO
  `fbsv2_vid_testimonial` (
    `vid_testimonial_aid`,
    `vid_testimonial_category`,
    `vid_testimonial_vid_link`,
    `vid_testimonial_logo_img`,
    `vid_testimonial_name`,
    `vid_testimonial_course`,
    `vid_testimonial_school`,
    `vid_testimonial_message`,
    `vid_testimonial_created`,
    `vid_testimonial_datetime`
  )
VALUES
  (
    8,
    'Continuing Studies',
    'https://www.youtube.com/watch?v=xnHrbjA0WZY',
    'lc.png',
    'Paul Reinier Vista',
    'Upskill Trainee',
    '',
    'It is fulfilling, especially learning tools like SASS, Tailwind, WordPress, and Figma. Aside from the technical skills, they taught us how to act professionally in a working environment.',
    '2024-11-07 10:52:17',
    '2024-11-07 10:52:17'
  ),
  (
    9,
    'Continuing Studies',
    'https://www.youtube.com/watch?v=PnBWVserVps',
    'lc.png',
    'Jinuel Zymon I. Ramos',
    'BSCS Graduate',
    '',
    'To all college graduates, I encourage you to pursue your continuing studies and training here at FBS. This will help you prepare professionally to join the competitive tech industry.',
    '2024-11-07 10:53:25',
    '2024-11-07 10:53:25'
  ),
  (
    10,
    'Continuing Studies',
    'https://www.youtube.com/watch?v=u-XPdxpKosw',
    'plsp.png',
    'Kurt Lui Juan Balanial',
    'PLSP Graduate',
    '',
    'My training here at FBS has been an invaluable experience that equipped me with essential skills in front-end and back-end development. Beyond that, the environment and professionalism at FBS have empowered me and prepared me to take on future challenges in the tech industry.',
    '2024-11-07 10:56:42',
    '2024-11-07 10:56:42'
  ),
  (
    11,
    'High School Work Immersion',
    'https://www.youtube.com/watch?v=MlBrBmufpy4',
    'slis.png',
    'Christian Jaekhob Dela Cruz',
    'Grade 12 HUMSS',
    'South Lakes Integrated School',
    'The program was also very beneficial to me—I learned a lot about potential jobs I could take in the future, and it helped me become a better person thanks to their PLEs after almost every task we completed.',
    '0000-00-00 00:00:00',
    '2024-11-07 10:59:15'
  ),
  (
    12,
    'High School Work Immersion',
    'https://www.youtube.com/watch?v=-OI3L6mWmsA',
    'spc.png',
    'Justine Clein Gelindon',
    'Grade 12 ICT',
    'San Pablo Colleges',
    'I had a very enjoyable experience here at FBS. Everything we did at FBS was truly enjoyable, from web designing using Figma to creating our own websites with HTML and CSS.',
    '0000-00-00 00:00:00',
    '2024-11-07 11:00:35'
  ),
  (
    13,
    'High School Work Immersion',
    'https://www.youtube.com/watch?v=GJNpd6naWUI',
    'mfmc.png',
    'Althea Mae Lat',
    'Grade 12 HUMSS',
    'Marcelino Fule Memorial College',
    'My experience was very fun, and all the trainers were kind and approachable. I highly recommend the FBS work immersion program because you will learn a lot here.',
    '0000-00-00 00:00:00',
    '2024-11-07 11:01:32'
  ),
  (
    14,
    'College On-the-job Training',
    'https://www.youtube.com/watch?v=w6_k-pnlaE0&t=1s',
    'dlsl_official_logo.png',
    'Thea Lyzette Consignado',
    '',
    'De La Salle Lipa Trainee',
    'I have learned a lot, and my overall experience will be very helpful not only in my future career, but also in building and shaping myself.',
    '0000-00-00 00:00:00',
    '2024-11-07 11:03:48'
  ),
  (
    15,
    'College On-the-job Training',
    'https://www.youtube.com/watch?v=rGtLB1x58ts',
    'lspu.png',
    'Mark Ryan Merin',
    'Laguna State Polytechnic Univ.',
    ' SPC Campus',
    'I am grateful to Frontline Business Solutions for providing me with a training and the support I needed to become what I am today. Their programs are designed to help people like me to gain the skills and knowledge that is neccesary to success in this field.',
    '0000-00-00 00:00:00',
    '2024-11-07 11:05:12'
  ),
  (
    16,
    'College On-the-job Training',
    'https://www.youtube.com/watch?v=7fGYHbtnCQk',
    'lc.png',
    'Aileah Marie Lozada',
    'Laguna College Trainee',
    '',
    'They did not just help me improve my web designing skills, but they also gave me strength and advises regarding personality and values that I can adopt from them to the IT industry.',
    '2024-11-07 11:06:16',
    '2024-11-07 11:06:16'
  );
...
--
ALTER TABLE `fbsv2_careers` ADD PRIMARY KEY (`careers_aid`);

--
-- Indexes for table `fbsv2_events_activities`
--
ALTER TABLE `fbsv2_events_activities` ADD PRIMARY KEY (`events_activities_aid`);

--
-- Indexes for table `fbsv2_home_banner`
--
ALTER TABLE `fbsv2_home_banner` ADD PRIMARY KEY (`home_banner_aid`);

--
-- Indexes for table `fbsv2_home_insights`
--
ALTER TABLE `fbsv2_home_insights` ADD PRIMARY KEY (`home_insights_aid`);

--
-- Indexes for table `fbsv2_home_testimonial`
--
ALTER TABLE `fbsv2_home_testimonial` ADD PRIMARY KEY (`home_testimonial_aid`);

--
-- Indexes for table `fbsv2_industry_testimonial`
--
ALTER TABLE `fbsv2_industry_testimonial` ADD PRIMARY KEY (`industry_testimonial_aid`);

--
-- Indexes for table `fbsv2_lcss_batch`
--
ALTER TABLE `fbsv2_lcss_batch` ADD PRIMARY KEY (`lcss_batch_aid`);

--
-- Indexes for table `fbsv2_pricing`
--
ALTER TABLE `fbsv2_pricing` ADD PRIMARY KEY (`pricing_aid`);

--
-- Indexes for table `fbsv2_pricing_services`
--
ALTER TABLE `fbsv2_pricing_services` ADD PRIMARY KEY (`pricing_services_aid`);

--
-- Indexes for table `fbsv2_special_offers`
--
ALTER TABLE `fbsv2_special_offers` ADD PRIMARY KEY (`special_offers_aid`);

--
-- Indexes for table `fbsv2_vid_testimonial`
--
ALTER TABLE `fbsv2_vid_testimonial` ADD PRIMARY KEY (`vid_testimonial_aid`);
...
--
ALTER TABLE `fbsv2_careers` MODIFY `careers_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 5;

--
-- AUTO_INCREMENT for table `fbsv2_events_activities`
--
ALTER TABLE `fbsv2_events_activities` MODIFY `events_activities_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 12;

--
-- AUTO_INCREMENT for table `fbsv2_home_banner`
--
ALTER TABLE `fbsv2_home_banner` MODIFY `home_banner_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 8;

--
-- AUTO_INCREMENT for table `fbsv2_home_insights`
--
ALTER TABLE `fbsv2_home_insights` MODIFY `home_insights_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 10;

--
-- AUTO_INCREMENT for table `fbsv2_home_testimonial`
--
ALTER TABLE `fbsv2_home_testimonial` MODIFY `home_testimonial_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 16;

--
-- AUTO_INCREMENT for table `fbsv2_industry_testimonial`
--
ALTER TABLE `fbsv2_industry_testimonial` MODIFY `industry_testimonial_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 35;

--
-- AUTO_INCREMENT for table `fbsv2_lcss_batch`
--
ALTER TABLE `fbsv2_lcss_batch` MODIFY `lcss_batch_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 69;

--
-- AUTO_INCREMENT for table `fbsv2_pricing`
--
ALTER TABLE `fbsv2_pricing` MODIFY `pricing_aid` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fbsv2_pricing_services`
--
ALTER TABLE `fbsv2_pricing_services` MODIFY `pricing_services_aid` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fbsv2_special_offers`
--
ALTER TABLE `fbsv2_special_offers` MODIFY `special_offers_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 13;

--
-- AUTO_INCREMENT for table `fbsv2_vid_testimonial`
--
ALTER TABLE `fbsv2_vid_testimonial` MODIFY `vid_testimonial_aid` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 17;
