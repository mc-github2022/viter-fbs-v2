...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2024 at 12:12 AM
...
CREATE TABLE `fbsv2_careers` (
  ...
  `careers_img` varchar(100) NOT NULL,
...
INSERT INTO `fbsv2_events_activities` (`events_activities_aid`, `events_activities_img`, `events_activities_img_list`, `events_activities_category`, `events_activities_title`, `events_activities_slug`, `events_activities_date`, `events_activities_description`, `events_activities_created`, `events_activities_datetime`) VALUES
...
(12, 'immersion-students-inside-training-room-2-image-12.jpg', 'summerCamp.jpg, swimming.jpg', 'Test', 'Test', 'test', '2024-12-09', '<p>\nRecently, the newly hired employees of Frontline Business Solutions, Inc. participated in an inspiring Employee Development Program centered on The Ideal Team Player, based on Patrick Lencioni\'s renowned book. The session, facilitated by Mr. Jhonny Jose Dichoso, Head of the Learning Center Solutions department, highlighted the three key virtues that define an ideal team player: being humble, hungry, and smart. As part of its commitment to holistic employee growth, Frontline Business Solutions aims for its workforce to embody these virtues, fostering a collaborative and high-performing organizational culture.\n</p>\n\n<p>\nThe program included interactive discussions, practical activities, and real-life applications of the virtues, ensuring that participants gained a deeper understanding of their significance. Mr. Dichoso emphasized that humility nurtures teamwork, hunger drives excellence, and being smart enhances interpersonal dynamics—all of which are essential for personal and team success. By instilling these values, Frontline Business Solutions reaffirms its mission to develop employees who not only contribute to the company\'s success but also create a positive impact within the workplace and the communities they serve.\n</p>\n\n<p>\nExplanation of the Three Virtues:\n</p>\n\n<p>\n<b>Humble:</b> Humility is about putting the team’s success above personal glory. Humble employees recognize others\' contributions, own up to their mistakes, and strive for collective achievement over individual accolades.\n</p>\n\n<p>\n<b>Hungry:</b> Hunger reflects an innate drive for continuous improvement and excellence. Hungry employees are self-motivated, diligent, and eager to go above and beyond to meet team and organizational goals.\n</p>\n\n<p>\n<b>Smart:</b> Being smart refers to emotional intelligence and strong interpersonal skills. Smart employees understand team dynamics, communicate effectively, and manage relationships with empathy and tact.\n</p>\n\n<p>\nThrough this program, Frontline Business Solutions empowers its employees to embrace these virtues, shaping them into ideal team players ready to contribute to the company’s mission and vision.\n</p>\n\n</div>', '2024-12-09 15:54:22', '2024-12-13 12:07:52');
...
INSERT INTO `fbsv2_home_insights` (`home_insights_aid`, `home_insights_img`, `home_insights_category`, `home_insights_title`, `home_insights_slug`, `home_insights_date`, `home_insights_paragraph_a`, `home_insights_paragraph_b`, `home_insights_paragraph_c`, `home_insights_created`, `home_insights_datetime`) VALUES
...
(7, 1, 'Mark Bumagat', 'mark.bumagat@frontlinebusiness.com.ph', '', 'default-receiver', '2024-12-04 13:09:47', '2024-12-18 13:33:02'),
(8, 1, 'Louren Isobel Rubico', 'lourenisobel18@gmail.com', '09123456789', 'subscribers', '2024-12-18 09:49:54', '2024-12-18 09:49:54');
...
(8, 1, 'Louren', 'Rubico', 'lourenisobel18@gmail.com', '', 10, '946ba6b2e8078e6b668a4bc5bf7b0c401592d6c162ba3c3f5f910d6bcf079f82', '', '2024-12-20 10:05:28', '2024-12-20 09:33:09');
...
--
ALTER TABLE `fbsv2_careers`
  MODIFY `careers_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
