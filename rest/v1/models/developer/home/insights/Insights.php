...
class Insights
{
    ...
    public $home_insights_meta_description;
    ...
    public function create()
    {
        try {
            ...
            $sql .= "home_insights_meta_description, ";
            ...
            $query->execute([
                ...
                "home_insights_meta_description" => $this->home_insights_meta_description,
    ...
    public function update()
    {
        try {
            ...
            $sql .= "home_insights_meta_description = :home_insights_meta_description, ";
            $sql .= "home_insights_datetime = :home_insights_datetime ";
            $sql .= "where home_insights_aid = :home_insights_aid ";
            $query = $this->connection->prepare($sql);
            $query->execute([
