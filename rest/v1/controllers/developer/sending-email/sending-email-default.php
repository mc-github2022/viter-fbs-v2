...
if (isset($_SERVER['HTTP_AUTHORIZATION'])) {
    ...
    if ($mail["mail_success"] == true) {
        ...
        $notif->notification_log_course = $data["client_course"];
        $notif->notification_log_school = $data["client_school"];
        $notif->notification_log_number_of_hours = $data["client_number_of_hours"];
