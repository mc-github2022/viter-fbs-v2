...
if (array_key_exists("industry_testimonialid", $_GET)) {
  ...
  $industry_testimonial->industry_testimonial_position =  checkIndex($data, "industry_testimonial_position");
  $industry_testimonial->industry_testimonial_message = $data["industry_testimonial_message"];
  $industry_testimonial->industry_testimonial_category = $data["industry_testimonial_category"];
