...
if (isset($_SERVER['HTTP_AUTHORIZATION'])) {
    ...
    $subscriberEmail = checkIndex($data, "recipientEmail");
    $subscriberKey = checkIndex($data, "key");
    $subscriberReplyTo = $data["replyTo"];
    $sending_email_log_file = $data["sending_email_log_file"];
